...
My research goal is to enable machines to think better by developing AI systems that integrate memory and reasoning. I am particularly interested in (1) drawing on cognitive psychology to develop evaluation frameworks that can provide a comprehensive understanding of the thought processes of LLMs/VLMs, understanding the effects of interaction and distinctions between models' memorization and reasoning; and (2) advancing models' ability to think more effectively, including designing proper algorithms that improve the thinking process to make models more adaptive and flexible in complex, real-world contexts.
